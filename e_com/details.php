...
if(isset($_GET['pro_id'])){
  ...
  if (isset($row_p_cat) && is_array($row_p_cat)) {
    $p_cat_id = $row_p_cat['p_cat_id'] ?? null;
    $p_cat_title = $row_p_cat['p_cat_title'] ?? null;
} else {
    // Handle the case where $row_p_cat is null or not an array
    $p_cat_id = null;
    $p_cat_title = null;
}
...
<div class="co-md-6">
  <div class="bx">
   ...
   <?php addCart(); ?>
    ...
    <div class="form-group">
      <label class="col-md-5 control-label" >Choose Color</label>
      <div class="col-md-7">
    ...
    <p class="price"><i class="fa fa-money-bill-wave"></i><?php echo $p_price; ?> BDT</p>
